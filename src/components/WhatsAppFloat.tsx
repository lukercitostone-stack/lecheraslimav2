...
const WHATSAPP_URL =
  "https://api.whatsapp.com/send/?phone=51936897467&text=Hola%2C+quiero+informaci%C3%B3n+sobre+tu+web+&type=phone_number&app_absent=0";
...
export function WhatsAppFloat() {
  const phoneDisplay = formatPhonePE("51936897467");
